...
def create_or_update_service(project_name, namespace, port=5000, target_port=5000):
    ...
    service = client.V1Service(
        ...
        spec=client.V1ServiceSpec(
            ...
            ports=[client.V1ServicePort(port=port, target_port=target_port, protocol="TCP", name="http")],
            type="NodePort",
        ),
    )
    try:
