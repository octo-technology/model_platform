...
- Having models runners in the model platform is debatable
  ...
  - Running model requires specific ressources that an API doesn't need
...
- Model manager could provide an interface, but it requires to set up authentification, a service, etc. Doesn't seem mandatory
