...
const ProjectsPage = (() => {
  ...
  const DEMO_PROJECTS = [
    ...
    {
      name: "Predictive-Maintenance-Aircraft",
      owner: "AirFlotte Nationale - Data Science Team",
      scope: "Prédiction des pannes moteurs et maintenance prédictive sur la flotte moyen et long courrier. Modèles de détection d'anomalies et estimation de durée de vie résiduelle des composants critiques. Objectif: réduire les AOG et optimiser les cycles de maintenance.",
      data_perimeter: "Données IoT des capteurs moteurs (température, vibrations, pression, régime): 200+ paramètres par vol. Historique de maintenance de 15 ans sur 250 appareils. RGPD: Non applicable - Données techniques d'aéronefs uniquement.",
    },
    {
      name: "Smart-Grid-Load-Forecasting",
      owner: "ÉlectriGrid France - Energy Transition Lab",
      scope: "Prévision de la consommation électrique à court terme (J+1, H+1) et moyen terme (S+1) par région et par segment. Intégration des énergies renouvelables intermittentes. Aide au pilotage du réseau et à l'équilibrage offre/demande.",
      data_perimeter: "Historique de consommation depuis 2010 (courbes de charge 30min) pour 35M de compteurs connectés. Données météo Météo-France. RGPD: Conforme - Agrégation systématique au niveau départemental (k-anonymat k>1000).",
    },
    {
    ...
    },
    {
      ...
      scope: "Optimisation des stocks et prévision de la demande pour les produits frais en grande distribution. Réduction du gaspillage alimentaire et des ruptures de stock. Modèles différenciés par catégorie de produit.",
      data_perimeter: "Historique des ventes quotidiennes sur 3 ans pour 12000 références dans 5000 magasins. Données météo locale, événements, logistiques. RGPD: Conforme - Aucune donnée personnelle collectée.",
    },
    {
      name: "Chatbot-Tax-Assistance",
      owner: "DGFiP (Direction Générale des Finances Publiques) - Innovation Numérique",
      scope: "Assistant conversationnel pour répondre aux questions des contribuables sur la déclaration d'impôts. RAG sur le corpus légal et fiscal français. Traite 80% des questions de niveau 1, escalade vers conseiller si besoin.",
      data_perimeter: "Base documentaire: Code Général des Impôts, BOFiP, guides pratiques (2000+ documents). Logs anonymisés. RGPD: Conforme - Aucune donnée fiscale individuelle. Base légale: mission de service public (article 6.1.e).",
    },
    {
      name: "Autonomous-Vehicle-Perception",
      owner: "AutoTech Motors - Software Defined Vehicle Division",
      scope: "Système de perception pour véhicule autonome niveau 3: détection piétons, véhicules, signalisation. Fusion multi-capteurs (caméras, LiDAR, radar). Validation selon ISO 26262 pour déploiement sur véhicules électriques.",
      data_perimeter: "5000 heures de conduite annotées: images multi-caméras (8 caméras), nuages de points LiDAR, données radar. ~10M de frames. RGPD: Conforme - Floutage automatique des visages et plaques d'immatriculation.",
    },
  ];
