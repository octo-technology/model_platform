...
pytestmark = [
    ...
    pytest.mark.skipif(not SKLEARN_AVAILABLE, reason="scikit-learn or mlflow not available"),
]
...
class TestModelTraining:
    ...
    def test_train_and_push_model_to_mlflow(self, login_and_setup_project):
        ...
        assert is_mlflow_reachable(PROJECT_NAME), f"MLflow registry for {PROJECT_NAME} is not reachable"
